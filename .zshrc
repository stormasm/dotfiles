...
export PATH=~/mia/sqlitetools:~/mia/rust/bin:~/mia/uv/python/bin:~/mia/uv/bin:/usr/local/bin:/Applications/Postgres.app/Contents/Versions/latest/bin:~/.rvm/bin:~/mia/protoc/bin:~/mia/node/bin:~/mia/zig15:~/mia/go/bin:~/go/bin:~/mia/gh/bin:~/mia/nvim/bin:~/.cache/rebar3/bin:~/.local/bin:$PATH
...
# Ghostty
export GHOSTTY_SOURCE_DIR="$HOME/j/tmp06/ghostty"
...
alias gc='git clone'
alias gcfast='git clone --depth=1'
...
alias irr='cd ~/j/tmp99/spanish/verbs/irregular'
alias irrex='cd ~/j/tmp99/spanish/verbs/irregular/examples'
...
alias 24='cd ~/j/tmp24'
alias 25='cd ~/j/tmp25'
alias 26='cd ~/j/tmp99/tmp26'
alias 27='cd ~/j/tmp99/tmp27'
alias 28='cd ~/j/tmp28'
alias 29='cd ~/j/tmp29'
...
# pnpm
export PNPM_HOME="/Users/ma/Library/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
