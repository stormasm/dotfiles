...
export PATH=~/mia/sqlitetools:~/mia/rust/bin:/usr/local/bin:/Applications/Postgres.app/Contents/Versions/latest/bin:~/.rvm/bin:~/mia/protoc/bin:~/mia/node/bin:~/mia/zig:~/mia/go/bin:~/go/bin:~/mia/gh/bin:~/.local/bin:$PATH
